...
function addSprite() {
	...
	var hq_moviesLikedSVG	= hq_svgFragment+'-movies-liked q-header'+hq_svgFragmentUse+'#movies-liked'+hq_svgFragmentSuffix;
	var hq_clubHeaderSVG	= hq_svgFragment+'-clubs--header q-header'+hq_svgFragmentUse+'#clubs-header'+hq_svgFragmentSuffix;
	var hq_clubHeaderXSVG	= hq_svgFragment+'-clubs--header q-header'+hq_svgFragmentUse+'#clubs-header-xxx'+hq_svgFragmentSuffix;
